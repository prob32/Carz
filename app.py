...
count_graphics = html.Div([
     ...
     dbc.Row([
      dbc.Col(
            ...
            html.P(
              """A large part of car used car buying is knowing how big a pool of total vehicles are available, browse by make or model. Due to the number large number of car makes and models a manufacturer must have a minimum of 10,0000 makes or models to appear on this graphic"""
     ...
     dbc.Row([
        ...
        dbc.Col(
            html.Div([
                ...
                html.P(
              """Intutively we know that used car buying is largerly a trade off between mileage, vehicle age and price. Use the below inputs to create different scatterplots. See if you can determine relationship's between, price and mileage or years and mileage. Try it out!"""
                )
                ],style={'marginLeft': 20,'width': '90%','display':'inline-block'})
              ...
              html.Div([
                ...
                html.P(
                    """This heatmap is a static PNG created from the seaborn package for python. It maps the correlation 
                        ...
                        price have a negative coefficient. The coefficent for year is by far the largest at 40%, what 
